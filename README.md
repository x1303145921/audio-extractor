...
1. **下载**：到 [Releases](https://github.com/x1303145921/audio-extractor/releases) 页下载最新版 `audio-extractor-portable-vX.X.X.zip`（国内可把链接开头的 `https://github.com/` 换成 `https://ghfast.top/https://github.com/` 走镜像加速）。
